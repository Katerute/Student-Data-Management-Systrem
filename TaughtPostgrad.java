...
public final class TaughtPostgrad extends TaughtStudent{
	
	//constants
	private final static int CREDITS = 180;
	private final int PASS_MARK = 50;

	//constructor
	public TaughtPostgrad(Name name, Date dateOfBirth){
	...
	public boolean correctlyRegistred() {
		...
		if(creditNumber==CREDITS)//check whether there is enough of credits
		{
			return (true && super.correctlyRegistred());
				...
				System.out.println("The student is registred for less credits than has to. The number of credits now: "+creditNumber+" out of "+CREDITS);
				return false;
		}
	}
